...
def check_common_ports(url, ports_to_check=None, timeout=1):
    ...
    if ports_to_check is None:
         ...
         ports_to_check = [80, 443] # Start simple, based on example/common use
    ...
    # Format to match example: "result :: 80 open"
    # For simplicity, we'll return the list and let frontend format it
